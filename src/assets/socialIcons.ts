const socialIcons = {
  ...
  Bluesky: `<svg
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M6.335 5.144c-1.654 -1.199 -4.335 -2.127 -4.335 .826c0 .59 .35 4.953 .556 5.661c.713 2.463 3.13 2.75 5.444 2.369c-4.045 .665 -4.889 3.208 -2.667 5.41c1.03 1.018 1.913 1.59 2.667 1.59c2 0 3.134 -2.769 3.5 -3.5c.333 -.667 .5 -1.167 .5 -1.5c0 .333 .167 .833 .5 1.5c.366 .731 1.5 3.5 3.5 3.5c.754 0 1.637 -.572 2.667 -1.59c2.222 -2.202 1.378 -4.745 -2.667 -5.41c2.314 .381 4.731 .094 5.444 -2.369c.206 -.708 .556 -5.071 .556 -5.661c0 -2.953 -2.681 -2.025 -4.335 -.826c-2.16 1.548 -3.665 4.27 -3.665 5.856c0 -1.586 -1.505 -4.308 -3.665 -5.856z"></path>
    </svg>`,
  Threads: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M19 7.5c-1.333 -3 -3.667 -4.5 -7 -4.5c-5 0 -8 2.5 -8 9s3 9 8 9c4 0 6.5 -2 7 -5"></path>
      <path d="M12 16c-2.667 0 -4 -1.333 -4 -4c0 -2.667 1.333 -4 4 -4c2 0 3.333 .667 4 2c.667 1.333 .667 2.667 0 4c-1 1.333 -2.333 2 -4 2z"></path>
    </svg>`,
  Website: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
